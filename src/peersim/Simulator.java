...
{
	String arg = "./data/config.txt";
	long time = System.currentTimeMillis();	
	
	System.err.println("Simulator: loading configuration");
	
	// config only can be set once, and Configuration becomes read-only.
	Configuration.setConfig( new ParsedProperties(arg) );
	...
	// ÓĐsimulation.endtimežÍĘÇevent-based
...
public static void exportExcel() {
    ...
    HSSFSheet wbSheet = wb.createSheet("loss");
    ...
    try {
        FileOutputStream fileOutputStream = new FileOutputStream(
                new File("D:/koori/learning/gossipLearning/loss/loss.xls"));
